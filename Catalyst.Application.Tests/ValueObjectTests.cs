...
/// <summary>
/// Tests for EipPoints value object
/// </summary>
public class EipPointsValueObjectTests
{
    [Fact]
    ...
    [Fact]
    public void Create_WithZero_ReturnsEipPoints()
    {
        // Act
        var eipPoints = EipPoints.Create(0);

        // Assert
        eipPoints.Value.Should().Be(0);
    }
    ...
    [Fact]
    public void Subtract_WithNegativeAmount_ThrowsException()
    {
        // Arrange
        var eipPoints = EipPoints.Create(100);

        // Act
        var action = () => eipPoints.Subtract(-10);
...
/// </summary>
public class UserIdValueObjectTests
{
    [Fact]
